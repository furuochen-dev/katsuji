...
固定版本（推荐，把 `1.2.0` 换成你要的版本）：

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katsuji@1.2.0/dist/katsuji.css">
<script src="https://cdn.jsdelivr.net/npm/katsuji@1.2.0/dist/katsuji.js"></script>
```
